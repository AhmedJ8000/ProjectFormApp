...
namespace ProjectWebApp.Controllers
{
    ...
    {
        private readonly ProjectIdentityDBContext _context;

        public CategoriesController()
        {
            _context = new ProjectIdentityDBContext();
        }
        ...
        {
            ViewData["ManagerId"] = new SelectList(_context.AspNetUsers, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("CategoryId,CategoryName,Description,ManagerId")] Category category)
        {
            ...
            ViewData["ManagerId"] = new SelectList(_context.AspNetUsers, "Id", "Id", category.ManagerId);
            return View(category);
        }
